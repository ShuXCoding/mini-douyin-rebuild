...
type user struct {
	...
	IsFollow        field.Int32
	Password        field.String
	Avatar          field.String
	BackgroundImage field.String
	Signature       field.String
	TotalFavorited  field.Int32
	WorkCount       field.Int32
...
func (u userDo) GetUserInfo(id int) (result model.User, err error) {
...
func (u userDo) GetUserPassword(username string) (result string, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, username)
	generateSQL.WriteString("SELECT password FROM user WHERE username=? ")
...
func (u userDo) FindUserByUsername(username string) (result int, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, username)
	generateSQL.WriteString("SELECT id FROM user WHERE username=? ")
